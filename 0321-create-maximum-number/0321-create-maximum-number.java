...
//     321.
    ...
    // nums2 using
    // the concept
    // from leetcode 1673(monotonously decreasing
    // stack here, that
    // is the
    // only change)
    // Merge the

    // two numbers(here they are in the form of arrays) such that it forms the greatest number
    // Find the greatest among all the formed numbers.
